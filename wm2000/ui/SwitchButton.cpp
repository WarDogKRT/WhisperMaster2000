    ...
    , _enabled(true)
{
    ...
    _oncolor = color;
    //_oncolor = QColor(205, 55, 45); => red backround
    _tol = 0;
    _borderradius = 12;
    ...
    , _pencolor(QColor(170, 170, 170))
{
    ...
    QColor cGrad1(_color.red(), _color.green()-16, _color.blue(), _color.alpha());

    _lg = QLinearGradient(0, 25, 70, 0);
    _lg.setColorAt(0, cGrad1);
    _lg.setColorAt(0.25, _color);
    _lg.setColorAt(0.95, cGrad1);
